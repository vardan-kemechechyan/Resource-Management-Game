...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty custInpManager;
    ...
    protected virtual void OnEnable()
    {
        ...
        custInpManager = serializedObject.FindProperty( "m_CustomInputManager" );
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField( custInpManager, new GUIContent( "Input Manager", "Controls all the input managmement in the game" ) );
    }
